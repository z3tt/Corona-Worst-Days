...
system("magick.exe -delay 30 *.png -delay 150 *latest_1.png -loop 0 corona_heat_sum.gif")
...
## convert png's to gif
system("magick.exe -delay 30 *.png -delay 150 *latest_1.png -loop 0 corona_heat_begin.gif")
...
## convert png's to gif
system("magick.exe -delay 30 *.png -delay 150 *latest_1.png -loop 0 corona_heat_lng.gif")
