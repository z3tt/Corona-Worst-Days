...
theme_update(axis.text.x = element_text(size = 14),
             ...
             legend.position = "top",
             legend.title = element_text(size = 18, color = "grey40"),
             legend.text = element_text(family = "Overpass", size = 16, color = "grey40"),
...
system("magick.exe -delay 40 *.png -delay 800 *latest_1.png -loop 0 corona_heat_sum.gif")
...
for(i in first_day:latest_day) {
  ...
  g <-
    ...
    labs(x = NULL, y = NULL, 
         title = "<b style='color:#c93a6e;'>The Worst Days:</b> Peaks in Confirmed Daily Deaths Due to COVID-19 So Far",
         caption = "**The visualization shows countries with at least 100 reported deaths due to the corona virus disease (COVID-19).** The color intensity for each day and country is estimated as<br>the number of deaths on this particular day divided by the highest daily death toll so far. The countries are ranked by the day of the first confirmed death due to COVID-19.<br>* On April 17<sup>th</sup> 2020, officials in Wuhan, China, revised the city´s coronavirus death toll. The deaths have been added proportionally to the daily confirmed deaths of China until that date.<br><br>**Visualization: Cédric Scherer  •  Data: Johns Hopkins University Center for Systems Science and Engineering (CSSE) via datahub.io**")
...
## convert png's to gif
system("magick.exe -delay 40 *.png -delay 800 *latest_1.png -loop 0 corona_heat_begin.gif")
...
for(i in first_day:latest_day) {
  ...
  g <-
    ...
    labs(x = NULL, y = NULL, 
         title = "<b style='color:#c93a6e;'>The Worst Days:</b> Peaks in Confirmed Daily Deaths Due to COVID-19 So Far",
         caption = "**The visualization shows countries with at least 100 reported deaths due to the corona virus disease (COVID-19).** The color intensity for each day and country is estimated as<br>the number of deaths on this particular day divided by the highest daily death toll so far. The countries are ranked by the latitude of their centroid.<br>* On April 17<sup>th</sup> 2020, officials in Wuhan, China, revised the city´s coronavirus death toll. The deaths have been added proportionally to the daily confirmed deaths of China until that date.<br><br>**Visualization: Cédric Scherer  •  Data: Johns Hopkins University Center for Systems Science and Engineering (CSSE) via datahub.io**")
...
## convert png's to gif
system("magick.exe -delay 40 *.png -delay 800 *latest_1.png -loop 0 corona_heat_lng.gif")
