...
f + 
  ...
  labs(x = "Number of days since first confirmed death due to COVID-19",
       ...
       caption = "**Visualization: Cédric Scherer  •  Data: Johns Hopkins University Center for Systems Science and Engineering (CSSE) via datahub.io**<br>Note: Charts contain all confirmed deaths due to COVID-19 since January 22<sup>nd</sup> to April 15<sup>th</sup> 2020 for countries with 50 or more deaths.")
