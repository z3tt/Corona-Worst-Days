...
theme_update(axis.text.x = element_text(size = 12),
             ...
             plot.title = element_markdown(family = "Overpass", size = 38, face = "bold",
...
ggplot(df,
  ...
  guides(fill = guide_colorbar(title.position = "top",
                               ...
                               barheight = unit(.6, "lines"))) +
  labs(x = NULL, y = NULL, 
       title = "<b style='color:#c93a6e;'>The Worst Days:</b> Which Countries are Currently Experiencing the<br>Highest Number of Confirmed Daily Deaths Due to COVID-19?",
