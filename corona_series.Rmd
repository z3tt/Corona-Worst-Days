...
dates <- c(23, 32, 46, 61, 75, 90)
dates_labs <- c("Jan 23", "Feb 1", "Feb 15", "Mar 1", "Mar 15", "Mar 30")
```
...
for(i in first_day:latest_day) {
  ...
  ggsave(here::here("2020_Corona", "plots", "series_sum", glue::glue("corona_sum_yday_{i}.pdf")),
  ...
  if(i == latest_day) {
    ...
    ggsave(here::here("2020_Corona", "plots", "series_sum", glue::glue("corona_sum_yday_latest.pdf")),
           width = 18.2, height = 12.2, device = cairo_pdf)
  }
}

## convert pdf's to png's
setwd(here::here("2020_Corona", "plots", "series_sum"))
pdfs <- list.files(here::here("2020_Corona", "plots", "series_sum"), pattern = "*.pdf")

for(pdf in pdfs) {
  pdf_convert(pdf = here::here("2020_Corona", "plots", "series_sum", pdf), 
              format = "png", dpi = 200)
}

## convert png's to gif
system("magick.exe -delay 40 *.png -delay 700 *latest_1.png -loop 0 corona_series_sum.gif")
```
...
for(i in first_day:latest_day) {
  ...
  ggsave(here::here("2020_Corona", "plots", "series_begin", glue::glue("corona_begin_yday_{i}.pdf")),
         width = 18.2, height = 12.2, device = cairo_pdf)
  ...
  if(i == latest_day) {
    ...
    ggsave(here::here("2020_Corona", "plots", "series_begin", glue::glue("corona_begin_yday_latest.pdf")),
           width = 18.2, height = 12.2, device = cairo_pdf)
  }
}
...
## convert pdf's to png's
setwd(here::here("2020_Corona", "plots", "series_begin"))
pdfs <- list.files(here::here("2020_Corona", "plots", "series_begin"), pattern = "*.pdf")

for(pdf in pdfs) {
  pdf_convert(pdf = here::here("2020_Corona", "plots", "series_begin", pdf), 
              format = "png", dpi = 200)
}

## convert png's to gif
system("magick.exe -delay 40 *.png -delay 700 *latest_1.png -loop 0 corona_series_begin.gif")
```
